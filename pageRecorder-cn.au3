...
Func Main()
    ...
    $mainGUI = GUICreate("文档截图下载工具", 300, 200)
    GUISetFont(10)
    Local $btnSelectPage = GUICtrlCreateButton("选择页面区域", 50, 10, 200, 30)
    Local $btnSelectButton = GUICtrlCreateButton("选择翻页按钮", 50, 50, 200, 30)
    Local $btnStartCapture = GUICtrlCreateButton("开始下载", 50, 160, 200, 30)
	Local $lblPageCount = GUICtrlCreateLabel("页数", 50, 95, 50, 20)
    Local $txtPageCount = GUICtrlCreateInput("1", 80, 90, 40, 25)
	Local $checkboxAutoCrop = GUICtrlCreateCheckbox("自动裁边", 150, 90, 100, 25)
